// MemoryAllocate.cpp: определ€ет точку входа дл€ консольного приложени€.
//
...
//SIZE_T xMinimumEverFreeBytesRemaining; //не сохран€ть
...
{
	//подготовка пам€ти к размещению секторов
}
